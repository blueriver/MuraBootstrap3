...
<head>
	...
	<cfif YesNoFormat(m.content('searchExclude'))><meta name="robots" content="noindex"></cfif>
	...
	<!--- FAV AND TOUCH ICONS --->
	<link rel="shortcut icon" href="#m.globalConfig('corePath')#/modules/v1/core_assets/images/favicon.ico">
